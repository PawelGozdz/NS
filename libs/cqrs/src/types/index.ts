...
declare module '@nestjs/cqrs/dist/query-bus' {
	...
	type IInferredQueryHandler<QueryType extends QueryBase<unknown>> = QueryType extends QueryBase<infer ResultType>
...
declare module '@nestjs/cqrs/dist/command-bus' {
	...
	type IInferredCommandHandler<CommandType extends CommandBase<unknown>> = CommandType extends CommandBase<infer ResultType>
